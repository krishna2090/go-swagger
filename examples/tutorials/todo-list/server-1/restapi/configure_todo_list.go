...
import (
	...
	"github.com/krishna2090/go-swagger/examples/tutorials/todo-list/server-1/restapi/operations"
	"github.com/krishna2090/go-swagger/examples/tutorials/todo-list/server-1/restapi/operations/todos"
)
