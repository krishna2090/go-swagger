...
import (
	...
	"github.com/krishna2090/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations"
	"github.com/krishna2090/go-swagger/examples/tutorials/todo-list/server-2/restapi/operations/todos"
)
